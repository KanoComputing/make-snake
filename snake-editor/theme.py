...
theme = {
    "colors": {
        ...
        N_("Black"): (curses.COLOR_WHITE, curses.COLOR_BLACK),
        N_("Red"): (curses.COLOR_WHITE, curses.COLOR_RED),
        N_("Green"): (curses.COLOR_WHITE, curses.COLOR_GREEN),
        N_("Yellow"): (curses.COLOR_WHITE, curses.COLOR_YELLOW),
        N_("Blue"): (curses.COLOR_WHITE, curses.COLOR_BLUE),
        N_("Magenta"): (curses.COLOR_WHITE, curses.COLOR_MAGENTA),
        N_("Cyan"): (curses.COLOR_WHITE, curses.COLOR_CYAN),
        N_("White"): (curses.COLOR_WHITE, curses.COLOR_WHITE),
